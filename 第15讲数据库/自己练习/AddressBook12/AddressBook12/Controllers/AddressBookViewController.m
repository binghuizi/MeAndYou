   ...
   DataBaseManger *database = [[DataBaseManger alloc]init];
    ...
    for (NSString *key in self.sectionTitleArray) {
        ...
        for (NSDictionary *dic in array) {
          ...
          //添加到数据库中
                AddressBookModel *addrBook = [[AddressBookModel alloc]initWithImageName:addressModel.imageModel name:addressModel.nameModel phoneNumber:addressModel.phoneModel gender:addressModel.genderModel age:addressModel.ageGender hobby:addressModel.hobbyModel];

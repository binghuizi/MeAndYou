...
//图片 名字 各个状态 显示的位置
    ...
    self.playLabel           = [[UILabel alloc]initWithFrame:CGRectMake(10, 300, kWideth, 40)];
////字符串 + 传递过来的数据
//    NSString *movieName     = [NSString stringWithFormat:@"%@  国语 2015",self.model.movieName ];
//    NSString *movieLeader   = [NSString stringWithFormat:@"主演：%@",self.model.leaderModel];
//    NSString *movieDirector = [NSString stringWithFormat:@"导演：%@",self.model.directorModel];
//    NSString *movieAreay    = [NSString stringWithFormat:@"地区：%@",self.model.areaModel];
//    NSString *movieType     = [NSString stringWithFormat:@"类型：%@",self.model.typeModel];
//给各个label赋值 显示出来
    self.movieNameLable.text      = [NSString stringWithFormat:@"%@  国语 2015",self.model.movieName ];
    self.movieLeaderLabel.text    = [NSString stringWithFormat:@"主演：%@",self.model.leaderModel];
    self.movieDirectorLabel.text  = [NSString stringWithFormat:@"导演：%@",self.model.directorModel];
    self.movieAreayLabel.text     = [NSString stringWithFormat:@"地区：%@",self.model.areaModel];
    self.movieTypeLabel.text      = [NSString stringWithFormat:@"类型：%@",self.model.typeModel];;
    self.movieTimeLabel.text      = self.model.movieTime;
    self.movieIntroduceLabel.text = self.model.showIntroduce;
...
//字体大小
    ...
    self.imageView.image = [UIImage imageNamed:self.model.movieImage];
